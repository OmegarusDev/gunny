export const PARTS = {
  ...
  optic_dot: {
    ...
    mods: { bloomPerShot: -0.28, aimRate: 0.8, zoom: 0.05 },
  },
  optic_acog: {
    id: 'optic_acog',
    slot: 'optic',
    name: 'ACOG',
    cost: 340,
    desc: 'Zoom and tracking. Slightly slower snap.',
    mods: { bloomPerShot: -0.4, zoom: 0.18, aimRate: -0.3, bloomRecover: 0.6 },
  },
  optic_lpvo: {
    id: 'optic_lpvo',
    slot: 'optic',
    name: 'LPVO',
    cost: 620,
    desc: 'Strong zoom, excellent bloom control.',
    mods: { bloomPerShot: -0.55, zoom: 0.28, aimRate: 0.4, bloomRecover: 0.9, weight: 0.06 },
  },
  stock_none: {
    id: 'stock_none',
    slot: 'stock',
