...
export const STATS = [
  ...
  { id: 'pen', stack: 'add', min: 0.4, gunsmith: true, gunsmithLabel: 'PEN', format: (v) => v.toFixed(2), hint: 'Needs over 1.00 to punch through. Headshots and crits each add 0.12 and stack. Fully kitted Shoddy only gets there with both.' },
